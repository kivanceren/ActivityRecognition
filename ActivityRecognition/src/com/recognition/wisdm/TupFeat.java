...
public class TupFeat {
	 ...
	 *            first time in tuple
	 */
	public TupFeat(long user, String cAct2, long timestamp) {
		usr = user;
		act = cAct2;
		time = timestamp;
	}
	 ...
	 * @param timestamp
	 */
	public TupFeat(String cact, long timestamp){
	...
	public static TupFeat stringToTup(String s){
		...
		t = new TupFeat( values[1], Long.parseLong(values[2]) );
	...
	public synchronized String getAct() {
		return act;
	}
